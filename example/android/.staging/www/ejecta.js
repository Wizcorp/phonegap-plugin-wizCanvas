    ...
    window.document._eventInitializers.touchstart =
        ...
        window.document._eventInitializers.touchmove = function () {
            if (!touchInput) {
                ...
                touchInput.ontouchstart = function () {
                    publishTouchEvent('touchstart', arguments);
                };
                touchInput.ontouchend = function () {
                    publishTouchEvent('touchend', arguments);
                };
                touchInput.ontouchmove = function () {
                    publishTouchEvent('touchmove', arguments);
                };
            }
    };
